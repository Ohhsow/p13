...
if cmd_exists('yum'):
    ...
    subprocess.call(['yum', 'install', 'emacs', 'iftop', 'htop', 'tmux', 'git', 'python-setuptools', 'build-essential',
                     'scrot', 'ipython', 'python-virtualenvwrapper', 'bind-utils', '-y'])
elif cmd_exists('apt-get'):
    subprocess.call(['apt-get', 'update', '&&', 'apt-get', 'upgrade'])
    subprocess.call(['apt-get', 'install', 'emacs', 'iftop', 'htop', 'tmux', 'git', 'python-setuptools',
                     'build-essential', 'scrot', 'ipython', 'virtualenvwrapper', '-y'])
...
class Searcher(object):
    ...
    def solodukha_search(self, search_path):
        """Searches solodukha in the internet"""
    ...
    def searching_element(self, search_path):
        ...
        elif search_path == 'https://www.google.com/':
...
class Main(object):
    def __init__(self, new_browser='Firefox'):
        """Constructor"""
        self.project_path = r'/home/andrei/PycharmProjects/new'
        self.exec_path = self.project_path + r'geckodriver'
        self.new_browser = new_browser
        self.email = None
        self.password = None
        self.js = None
        self.search_path = ('https://www.yahoo.com/', 'https://www.google.com/', 'https://banana.by/',
                            'https://www.tut.by/', 'https://ru.wikipedia.org/')
